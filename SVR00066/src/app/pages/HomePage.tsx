...
const TICKER = ['Plant-Based','Heat Stable','HoReCa Ready','100% Vegan','No Dairy','Built for Kitchens','Premium Quality',
  ...
  return (
    <>
      ...
      <section className="hp-hero">
        ...
        <div className="hp-wm">
          <img src="/images/logo.png" alt="" aria-hidden style={{ width:'100%',height:'100%',objectFit:'contain',filter:'brightness(0) invert(1)' }} />
        </div>
