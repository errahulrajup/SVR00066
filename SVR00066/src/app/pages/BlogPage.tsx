...
import { useBlogPosts, usePageSeo } from '../hooks';
    ...
    <>
      ...
      <div style={{ background:'var(--bg-main)' }}>
        <section className="bl-hero">
          <div style={{ position:'absolute',inset:0,background:'radial-gradient(ellipse 80% 60% at 50% 0%,rgba(255,193,7,0.04) 0%,transparent 70%)' }} />
